...
const Dashboard = () => {
  const { isSubscribed, planLimits } = useSubscription();
              ...
              <Card className="border-border/50">
                <CardContent className="py-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <PlanLimitIndicator resource="executions" />
                  </div>
                </CardContent>
              </Card>
            </PageItem>
              ...
              <CardContent className="p-0">
                {hasExecutions ? (
                  ...
                  <div className="py-12 text-center">
                    ...
                    <LockedButton variant="outline" size="sm" feature="create your first automation">
